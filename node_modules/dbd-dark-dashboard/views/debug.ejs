...
<script src="../views/src/js/core/jquery.min.js"></script>
<script src="../views/src/js/core/popper.min.js"></script>
<script src="../views/src/js/core/bootstrap.min.js"></script>
<script src="../views/src/js/perfect_scrollbar.js"></script>
<script src="../views/src/js/plugins/chartjs.min.js"></script>
<script src="../views/src/js/plugins/bootstrap-notify.js"></script>
<script>
