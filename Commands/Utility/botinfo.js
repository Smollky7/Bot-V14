...
module.exports = {
    ...
    execute: async (interaction, client) => {
        ...
        let but4 = new ButtonBuilder().setURL("https://discord.com/api/oauth2/authorize?client_id=ID&permissions=8&scope=applications.commands%20bot").setLabel("Invite").setStyle(ButtonStyle.Link).setEmoji("1014738330627346512")
      ...
      let dev = client.members.cache.get("479733668559192066")
        const statsEmbed = new EmbedBuilder()
        .setColor("Random")
        .setTitle("Bot Information")
        .setDescription(`[**Invite**](https://discord.com/) ● [**Support Server**](https://discord.gg/)`)
        .addFields (
            { name: `**Serves**`, value: `\`\`\`Total: ${client.guilds.cache.size} servers\`\`\``, inline: true },
            { name: `*Usuarios**`, value: `\`\`\`Total: ${client.guilds.cache.reduce((acc, guild) => acc + guild.memberCount, 0)} users\`\`\``, inline: true },
            { name: `**Node Versão**`, value: `\`\`\`v${process.versions.node}\`\`\``, inline: true },
